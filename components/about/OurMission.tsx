        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <p className="text-gray-600 text-2xl">
              SoftCamp está dedicado a proporcionar soluciones de gestión
              eficientes para campings pequeños y medianos. Nuestro software
              combina herramientas intuitivas con funcionalidades avanzadas,
              asegurando que los gestores puedan optimizar su ocupación,
              automatizar tareas repetitivas y mejorar la experiencia del
              cliente. Nos centramos en ofrecer tecnología práctica que resuelve
